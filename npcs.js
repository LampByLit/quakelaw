...
let npcJobs = [
    ...
    'shopkeeper', 'cashier', 'store manager', 'sales associate', 'meth cook', 'merchant',
    'cook', 'waiter', 'bartender', 'chef', 'barista', 'server', 'restaurant manager', 'businessman', 'businesswoman',
    'teacher', 'pimp', 'student', 'librarian', 'professor', 'tutor', 'expert', 'scientist', 'owner', 'business owner',
    'nurse', 'doctor', 'dentist', 'pharmacist', 'veterinarian', 'therapist', 'surgeon', 'criminal', 'stripper',
    'mechanic', 'carpenter', 'plumber', 'electrician', 'contractor', 'handyman', 'gang leader', 'cult lord',
    'police officer', 'security guard', 'firefighter', 'detective', 'sheriff', 'killer', 'general contractor',
    'mail carrier', 'delivery driver', 'taxi driver', 'truck driver', 'bus driver', 'representative', 'consultant', 
    'architect', 'engineer', 'designer', 'artist', 'musician', 'writer', 'journalist', 'investor', 'founder', 'cop', 'motorist',
    'mechanic', 'carpenter', 'plumber', 'electrician', 'contractor', 'handyman', 'gang leader', 'cult lord', 'driver', 'salesperson', 'accountant', 'bookkeeper', 'auditor', 'tax preparer', 'financial advisor', 'rich banker',
    'farmer', 'rancher', 'fisherman', 'gardener', 'landscaper', 'crackpot', 'raper', 'child abductor', 'real estate agent', 'insurance agent', 'banker', 'loan officer', 'crooked cop',
    'hairdresser', 'barber', 'cosmetologist', 'tailor', 'white collar criminal,',
    'baker', 'butcher', 'grocer', 'florist', 'drug dealer', 'hitman', 'super expert',
    'construction worker', 'roofer', 'painter', 'welder', 'mason', 'sex worker',
    'janitor', 'custodian', 'cleaner', 'maintenance worker', 'street hooker', 'crack dealer',
    'office manager', 'administrative assistant', 'data entry clerk', 'file clerk',
    'photographer', 'videographer', 'filmmaker', 'graphic designer', 'crack whore',
    'coach', 'trainer', 'athlete', 'soldier', 'homeless pederast', 'thief', 'unrepentent serial killer',
    'social worker', 'counselor', 'psychologist', 'psychiatrist', 'crime boss',
