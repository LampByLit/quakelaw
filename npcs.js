...
let npcCharacteristics = ['rude', 'joyful', 'insane', 'flirtatious', 'grumpy', 'cheerful', 'mysterious', 'talkative', 'quiet', 'energetic', 'lazy', 'nervous', 'confident', 'shy', 'bold', 'cautious', 'friendly', 'hostile', 'curious', 'indifferent', 'optimistic', 'pessimistic', 'wise', 'foolish', 'brave', 'sarcastic', 'serious', 'playful', 'anxious', 'calm', 'passionate', 'stoic', 'charismatic', 'aloof', 'gossipy', 'reserved', 'impulsive', 'methodical', 'stubborn', 'flexible', 'analytical', 'creative', 'paranoid', 'trusting', 'ambitious', 'laid-back', 'perfectionist', 'sloppy', 'gentle', 'aggressive', 'psychotic', 'delusional', 'mentally handicapped', 'racist', 'homosexual', 'homeless', 'drug addicted', 'violent', 'angry', 'stoned and high', 'confused', 'anarchstic', 'nihlistic', 'generous', 'wrathful', 'horny'];
