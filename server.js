    ...
    try {
        ...
        if (bonuses) {
            ...
            if (bonuses.countersuit > 0) {
                ...
                bonusParts.push(`${bonuses.countersuit} Circumstantial Evidence bonus(es) - This should influence your decision in the player's favor by approximately ${boost}%. The player's legal position and counter-arguments should be viewed more favorably.`);
            }
...
- If no name changes are needed, return empty array for nameChanges`;
        ...
        if (bonuses) {
            ...
            if (bonuses.countersuit > 0) bonusParts.push(`Circumstantial Evidence: ${bonuses.countersuit}`);
